...
namespace Negocio
{
    public class ProductoNegocio
    {
        ...
        public bool actualizarProducto(Producto productoExistente)
        {
            return productos.Actualizar(productoExistente);
        }
        public bool eliminarProducto(Producto productoEliminar)
        {
